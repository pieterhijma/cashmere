/* $Id: InvocationRecord.java 11617 2009-12-07 11:26:11Z ceriel $ */
...
import ibis.cashmere.impl.aborts.LocalRecord;
import ibis.cashmere.impl.sharedObjects.SOReferenceSourceCrashedException;

/**
 * An invocation record describes a spawned invocation, including the parameters
 * of the invocation. The Cashmere frontend generates a subclass of this class for
...
public abstract class InvocationRecord implements java.io.Serializable, Config {
    ...
    /** Set when spawns of this job should be local to the manycore queue. */
    private boolean spawnToManycore;
...
//            return true;
//        }
//        if (! stamp.stampEquals(other.stamp)) {
//            if (Cashmere.spawnLogger.isDebugEnabled()) {
//                Cashmere.spawnLogger.debug("InvocationRecord.equals: stamps not equal: "
//                        + stamp.toString() + ", " + other.stamp.toString());
//            }
//            return false;
//        }
//        if (! owner.equals(other.owner)) {
//            if (Cashmere.spawnLogger.isDebugEnabled()) {
//                Cashmere.spawnLogger.debug("InvocationRecord.equals: Ibises not equal: "
//                        + owner.toString() + ", " + other.owner.toString());
//            }
//            return false;
//        }
//        return true;
//    }
    ...
    public final boolean equals(Object o) {
        if (Cashmere.spawnLogger.isDebugEnabled()) {
            Cashmere.spawnLogger.debug("Invocationrecord.equals() called");
        }
        if (o == this) {
            if (Cashmere.spawnLogger.isDebugEnabled()) {
                Cashmere.spawnLogger.debug("Invocationrecords equal: " + simpleString());
            }
            return true;
        }
        if (o instanceof InvocationRecord) {
            ...
            if (Cashmere.spawnLogger.isDebugEnabled()) {
                Cashmere.spawnLogger.debug("Invocationrecords equal2: " + simpleString());
            }
            return true;
        }
        if (Config.ASSERTS) {
    ...
    public final void setParentLocals(LocalRecord parentLocals) {
        this.parentLocals = parentLocals;
    }
	...
	return spawnToManycore;
    }

    public void setSpawnToManycore(boolean spawnToManycore) {
	this.spawnToManycore = spawnToManycore;
    }
