/* $Id: Stamp.java 6240 2007-09-07 06:54:28Z ceriel $ */

package ibis.cashmere.impl.spawnSync;

/**
 * Implements globally-unique identifications for Cashmere jobs.
 */
public final class Stamp implements java.io.Serializable {
     ...
     * is no parent.
     */
    public static synchronized Stamp createStamp(Stamp parentStamp) {
    ...
    public static synchronized void deleteStamp(Stamp s) {
