...
public abstract class LoadBalancingAlgorithm implements Config {
    ...
    protected Cashmere cashmere;

    protected LoadBalancingAlgorithm(Cashmere s) {
        cashmere = s;
    }
    ...
    protected void throttle(long count) {
        ...
        int participants;
        synchronized (cashmere) {
            participants = cashmere.victims.size();
        }
        ...
        if (time > 0) {
            cashmere.stats.stealThrottleTimer.start();
            ...
            try {
                ...
                cashmere.stats.stealThrottleTimer.stop();
            }
        }
    }
}
