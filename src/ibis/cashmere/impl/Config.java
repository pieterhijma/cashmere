/* $Id: Config.java 13968 2011-11-03 12:38:56Z ceriel $ */
...
/**
 * Constants for the configuration of Cashmere. This interface is public because it
 * is also used in code generated by the Cashmere frontend.
 */
...
public interface Config {
    ...
    static final String PROPERTY_PREFIX = "cashmere.";
    ...
    /** Enable this if Cashmere should print statistics at the end. */
    static final boolean STATS = properties.getBooleanProperty(s_stats, true);

    /** Enable this if Cashmere should print statistics per machine at the end. */
    ...
    /**
     * Enable this if cashmere should run with a closed world: no nodes can join or
     * leave.
     */
    ...
    /**
     * Enable this if cashmere should use a lesser consistency model for
