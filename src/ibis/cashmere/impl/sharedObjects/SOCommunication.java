...
final class SOCommunication implements Config, Protocol {
    ...
    protected SOCommunication(Cashmere s) {
        this.s = s;
    }
    ...
    protected void init() {
        ...
        if (LABEL_ROUTING_MCAST) {
            try {
                ...
                commLogger.error("CASHMERE '" + s.ident
    ...
    /**
     * Creates SO receive ports for new Cashmere instances. Do this first, to make
        ...
        for (int i = 0; i < joiners.length; i++) {
            ...
            try {
                s.comm.ibis.createReceivePort(soPortType,
                        "cashmere so receive port for " + joiners[i],
    ...
    protected void sendAccumulatedSOInvocations() {
        ...
        if (soInvocationsDelayTimer > 0
            ...
            try {
                ...
                System.err.println("CASHMERE '" + s.ident
        ...
        if (LABEL_ROUTING_MCAST) {
            ...
            if (ASYNC_SO_BCAST) {
                ...
                SOInvocationRecord copy =
                        (SOInvocationRecord) Cashmere.deepCopy(r);
    ...
    protected void doBroadcastSOInvocationLRMC(SOInvocationRecord r) {
        ...
        soBcastLogger.debug("CASHMERE '" + s.ident
    ...
    protected void doBroadcastSharedObjectLRMC(SharedObject object) {
        ...
        soBcastLogger.info("CASHMERE '" + s.ident + "': broadcasting object: "
            + object.getObjectId());
        WriteMessage w = null;
        long size = 0;
    ...
    private void sendSORequest(String objectId, IbisIdentifier source,
        ...
        try {
            ...
            if (v == null) {
                ...
                soLogger.error("CASHMERE '" + s.ident + "': could not "
        ...
        while (true) {
            synchronized (s) {
                if (sharedObject != null) {
                    ...
                    soLogger.info("CASHMERE '" + s.ident
    ...
    protected void handleSORequests() {
        ...
        while (true) {
            ...
            if (ASSERTS && info == null) {
                soLogger.error("CASHMERE '" + s.ident
